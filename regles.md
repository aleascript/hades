...
En cas d'**égalité de succès ou d'exploit**, on peut exceptionnellement déclarer les compétiteurs ex-aequos mais si l'égalité n'est pas possible fictionnellement, on peut déclarer le gagnant in-extremis le camp qui a la somme des résultats pairs le plus grand (en privilégiant les protagonistes en cas d'égalité absolue).  
