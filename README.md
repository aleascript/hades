...
* A tout moment Chaos peut s'approprier le résultat. Il donne un dé héros à Cosmos dans ce cas. 

### Récupération de dés de destin

* Avant que Héros et Chaos ne jettent les dés, Cosmos récupèrent le différence de dés manquants entre Héros et Chaos. 

_Exemple: si côté héros il y a 3D et côté chaos 2D, cosmos gagne un dé chaos \(bleu\)._

### Jet de dés

* Coup de chance: pour chaque 6, le joueur peut lancer un autre dé \(en gardant le 6 comme pair bien sûr\).
* Si aucun pair des 2 côtés: -1 
* Si égalité des pairs: +1 
* On compte la différence entre Chaos et Héros bornée entre -3 et +3.
...
* Deus ex alea ?
* C'est Cosmos qui fait l'interprétation sauf si Chaos s'approprie l'interprétation \(en donnant un dé héros à Cosmos\).

| Résultat | Nom | Interprétation | Commentaire |
| :---: | :---: | :---: | :---: |
| -3 | Fiasco | NON ET | Préjudiciable \(jaute, trait, fiction...\) |
| -2 | Echec | NON | Fiction |
| -1 | Revers | NON MAIS | Fiction, bénéfice ? |
| +1 | Presque | OUI MAIS | Fiction, préjudice ? |
| +2 | Succès | OUI | Fiction |
| +3 | Exploit | OUI ET | Bénéfique \(jauge, trait, fiction...\) |

* C'est Cosmos qui rend la main en cas de conflit entre Héros et Chaos. Il se base sur les dés qu'il a obtenus. 
...
A l'issue de la session, les traits révélés négatifs deviennent établis et les traits révélés positifs disparaissent. Les jauges restent en l'état elles.
...
* Le camp gagnant doit avoir obtenu le meme chiffre sur tous les dés \(6 inclus\).
...
_**Table Quoi, Pourquoi, Comment ?**_
